...
- Из бота https://t.me/Brochurefinderbot выкачиваются документы в гугл диск по всем проектам из базы данных. Над скаченными документами выполняется следующая предобработка:
...
**Стоимость**: 6500 + 4000 + 1000 + 1000 руб.
